...
import es.jsomoza.rest.controllers.dto.MakerDTO;
import es.jsomoza.rest.entities.Maker;
import es.jsomoza.rest.entities.Maker.MakerBuilder;
...
public class MakerController {
    ...
    public ResponseEntity<?> saveMaker(@RequestBody MakerDTO makerDTO) throws URISyntaxException {
    	System.out.println("aqui entra en procedimiento");
        ...
        maker.setProductList(makerDTO.getProductList()
          .stream()
          .map(p -> { p.setMaker(maker); return p; })
          .toList());
