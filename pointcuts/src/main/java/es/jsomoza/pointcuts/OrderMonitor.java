...
public class OrderMonitor {
  ...
  @Before("execution(public * es.jsomoza.pointcuts.Restaurant.addOrder(..))")
  ...
  @AfterReturning(pointcut = "execution(* es.jsomoza.pointcuts.Restaurant.addOrder(..))", returning = "orderNumber")
  ...
  @AfterThrowing(pointcut = "execution(* es.jsomoza.pointcuts.Restaurant.addOrder(..))", throwing = "error")
  ...
  @Around("execution(* es.jsomoza.pointcuts.Restaurant.addOrder(..))")
